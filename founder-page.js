...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      'founder.eyebrow': '创始人履历',
      'founder.mediaReady': '本地媒体已同步', 'founder.mediaPending': '媒体快照待同步', 'founder.viewDetails': '查看项目详情', 'founder.linkedCase': '关联项目案例', 'founder.detailUnavailable': '该项目已关联，但本地媒体快照尚未同步。', 'founder.viewLibrary': '查看全部案例',
      'founder.back': '返回团队', 'founder.empty': '当前没有已关联的公开案例快照。',
    ...
    en: {
      ...
      'founder.eyebrow': 'Founder profile',
      'founder.mediaReady': 'Local media synced', 'founder.mediaPending': 'Media snapshot pending', 'founder.viewDetails': 'View project details', 'founder.linkedCase': 'Linked project case', 'founder.detailUnavailable': 'This project is linked, but its local media snapshot has not been synced yet.', 'founder.viewLibrary': 'View all cases',
      'founder.back': 'Back to team', 'founder.empty': 'No linked public case snapshot is available yet.',
  ...
  function displayCase(item, link) {
    ...
    return { local: local, title: title, client: client, intro: intro, approach: approach, media: media, id: id, record: item || null };
  }
